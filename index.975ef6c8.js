...
var _addTaskJs = require("./js/add-task.js");
_addTaskJs.taskForm.addEventListener("submit", _addTaskJs.addTaskOnClick);

},{"./js/add-task.js":"gHp12"}],"gHp12":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "taskInput", ()=>taskInput);
parcelHelpers.export(exports, "addTaskBtn", ()=>addTaskBtn);
parcelHelpers.export(exports, "taskList", ()=>taskList);
parcelHelpers.export(exports, "taskForm", ()=>taskForm);
parcelHelpers.export(exports, "addTaskOnClick", ()=>addTaskOnClick);
...
const addTaskOnClick = (e)=>{
    ...
    if (taskInput.value.trim() !== "") {
        taskList.insertAdjacentHTML("afterbegin", `<li class = "task-container">
        ...
        const saveOnChange = (e)=>{
            if (e.key === "Enter") task.setAttribute("readonly", "");
        };
        const deleteOnClick = ()=>{
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire2af1")
